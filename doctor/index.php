...
<body class="bg-light">
  ...
  <div class="container-fluid  px-lg-4 mt-4 mb-500">
    <div class="swiper mySwiper">
      ...
      <div class="swiper-wrapper">
        <div class="swiper-slide">
          <img src="https://s-i.huffpost.com/gen/3991424/images/o-DOCTOR-facebook.jpg" class="w-100" height="400px">
        </div>
        <div class="swiper-slide">
          <img src="https://www.concentra.com/-/media/project/concentra/dotcom/usa/images/hero-banner/occupational-medicine-500-hero.jpg?t=20200920015358" class="w-100" height="400px">
        </div>
        <div class="swiper-slide">
          <img src="https://ak3.picdn.net/shutterstock/videos/4808243/thumb/1.jpg" class="w-100" height="400px">
        </div>
        <div class="swiper-slide">
          <img src="https://www.sutterhealth.org/images/medical-doctors/indian-doctor-and-patient-584x285.jpg" class="w-100" height="400px">
        </div>
      </div>
    </div>
    ...
    <div class="intro " style="max-width: 600px; writing-mode: horizontal-tb;">
      <p align="justify">Rakshak is providing a Multi-Speciality hospital providing unique services in the field of General Surgery, Pulmonology, Endoscopy surgery, Lap surgery, Ortho surgery, Neuro surgery and Gynae surgery etc in addition to all broad specialties. Hospital has fully equipped operating theaters with C-ARM facility managed by highly qualified surgical teams in all respective field.</p>

      <p align="justify">
        We have on board, outstanding clinicians record to lead and develop teams for excellence in practice, education and research. We have highly experienced consultation Doctors for OPD and IPD.
      </p>
    ...
    <div class="imghos">
      <div class=" col-lg-5 col-md-5 mb-4 order-lg-2 order-md-2 order-1">
        <img src="https://th.bing.com/th/id/OIP.bjda2IPGn7tvWEXpnKJWIwHaE8?pid=ImgDet&rs=1" style="width : 450px" alt="">
      </div>
    </div>
    <br></br>
    ...
    <h2 class="mt-5 mb-4 pt-4 text-center fw-bold h-font">Top Doctors Providing Services Through Rakshak</h2><br></br>
    <div class="container">
